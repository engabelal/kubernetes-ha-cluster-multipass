...
# 1. Start Primary Control Plane First
echo -e "${GREEN}>>> Step 1: Starting master01 (primary control plane)...${NC}"
multipass start master01
echo -e "${GREEN}>>> Waiting for master01 to be ready...${NC}"
sleep 10

# 2. Start Secondary Control Plane
echo -e "${GREEN}>>> Step 2: Starting master02...${NC}"
multipass start master02
sleep 5

# 3. Start Workers Last
echo -e "${GREEN}>>> Step 3: Starting worker nodes...${NC}"
